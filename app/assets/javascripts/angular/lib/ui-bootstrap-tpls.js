  ...
  .directive('collapse', ['$transition', function ($transition) {
    ...
    return {
      link: function (scope, element, attrs) {
        ...
        var collapseHeight = typeof attrs.collapseHeight != "undefined" ? parseInt(attrs.collapseHeight) : 0;
        ...
        function collapse() {
          if (initialAnimSkip) {
            initialAnimSkip = false;
            collapseDone();
            element.css({height: collapseHeight});
          } else {
            ...
            doTransition({ height: collapseHeight }).then(collapseDone);
          }
        }
...
.controller('CarouselController', ['$scope', '$timeout', '$interval', '$transition', function ($scope, $timeout, $interval, $transition) {
  ...
  $scope.next = function() {
    ...
    if($scope.noCircular && $scope.currentIndex + 1 == slides.length) {
      return
    }
  ...
  $scope.prev = function() {
    ...
    if($scope.noCircular && $scope.currentIndex - 1 < 0) {
      return
    }
    ...
    link: function(scope, element, attrs, ngModel) {
      ...
      scope.$watch('isOpen', function(value) {
        if (value) {
          ...
          scope.position.left = scope.position.left;
